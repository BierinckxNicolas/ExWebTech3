...
public class XMLParser {
	...
	private String INPUTFILE = "betellingen.xml";
	...
	public String getBestellingen() {
		...
		try {
			...
			NodeList races = doc.getElementsByTagName("bestelling");

			for (int i = 0; i < races.getLength(); i++) {
				Node nNode = races.item(i);
				Element eElement = (Element) nNode;

				result += "<br/><b>Naam klant : </b>" + eElement.getAttribute("nameklant");
			    result += "<br/><b>Adres : </b>" + eElement.getAttribute("adress");
			    result += "<br/><b>Datum betelling : </b>" + eElement.getAttribute("dateBestelling");
				result += "<br/><b>Productnaam : </b>" + eElement.getAttribute("nameProduct");
				result += "<br/><b>Hoeveelheid : </b>" + eElement.getElementsByTagName("hoeveelheid").item(0).getTextContent();
				result += "<br/>";
